...
mkdir ../data_analysis
cd ../data_analysis
mkdir trajectories general pyinteraph specific vmd WAD
...
do
    ...
    mv md-rottrans.xtc ../../data_analysis/trajectories/$run.xtc
    cp 3_NPT/npt.gro ../../data_analysis/trajectories/$run.gro
